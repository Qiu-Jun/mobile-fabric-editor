...
import verticalImg from '@/static/images/control/middlecontrol.svg'
import horizontalImg from '@/static/images/control/middlecontrolhoz.svg'
import edgeImg from '@/static/images/control/edgecontrol.svg'
import rotateImg from '@/static/images/control/rotateicon.svg'
...
// 删除事件
function deleteObject(_eventData: any, transform: { target: any }) {
...
function initControls(canvas: {
  ...
  // 指定textbox
  const textBoxControls: any = (fabric.Textbox.prototype.controls = {})
